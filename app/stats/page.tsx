    ...
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-semibold mb-2 text-gray-600">Today</h3>
          <div className="text-4xl font-bold text-blue-600 mb-2">
            {stats.today.totalMinutes} min
          </div>
          <p className="text-gray-600">{stats.today.sessionCount} sessions</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-gray-600">{stats.week.sessionCount} sessions</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        {stats.recentSessions.length === 0 ? (
          <p className="text-gray-500">No sessions yet. Start studying!</p>
        ) : (
