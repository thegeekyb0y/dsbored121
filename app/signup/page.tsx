...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12">
      <div className="w-full max-w-6xl border-t-3 border-gray-600 hover:border-green-500 mx-auto h-[80vh]">
        {" "}
        {/* Universal margin container */}
        <div className="flex w-full h-full overflow-hidden border border-gray-800 shadow-2xl bg-[#1a1a1a]">
          {/* Left Side: Signup Functionality (2/3) */}
            ...
            <div className="max-w-md mx-auto w-full">
              <div className="text-center mb-10">
                ...
                <p className="text-gray-400 text-lg">
                  Join thousands of students mastering their focus
                </p>
              </div>
              ...
              <div className="space-y-6">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 bg-white text-black hover:bg-gray-200 font-bold py-4 px-6 rounded-xl cursor-pointer transition-all duration-200 transform hover:scale-[1.01] shadow-lg"
                >
                ...
                <div className="text-center">
                  <Link
                    href="/login"
                    className="text-krakedlight bg-krakedlight/20 hover:bg-krakedlight/10 p-4 rounded-sm hover:text-green-400 font-medium transition-colors"
                  >
